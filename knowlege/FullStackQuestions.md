...
* **What is polymorphism?**
  - In computer science polymorphism is the idea that a single interface could have multiple forms or data structures undernieth. For example the shape class and all the things that inherit form it (circle, square, etc).
  - MORE
* **What is encapsulation?** 
  - Encapsulation is the act of putting data inside of a function. This is important so that code stays specific to the problem it's addressing. The more specifica and reasonably granular you can get the better.
